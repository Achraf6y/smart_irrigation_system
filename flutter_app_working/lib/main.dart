...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color primaryColor =
        Color.fromARGB(255, 44, 116, 98); // ARGB values for the primary color
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          width: 400,
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 185, 197, 194)
                                .withOpacity(0.5),
                      ...
                      GestureDetector(
                        onTap: () =>
                            Navigator.pushNamed(context, '/luminosity'),
                        child: Container(
                          width: 400,
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 185, 197, 194)
          ...
          children: [
            Expanded(
              child: Container(
                ...
                margin: const EdgeInsets.only(
                    bottom: 8.0), // Adjust the spacing here
                decoration: BoxDecoration(
                  color: Colors.white,
                  boxShadow: [
                    BoxShadow(
            ...
            Expanded(
              child: Container(
                width: double.infinity,
                margin:
                    const EdgeInsets.only(top: 16.0), // Adjust the spacing here
                decoration: BoxDecoration(
                  color: Colors.white,
                  boxShadow: [
                    BoxShadow(
                      ...
                      child: Container(
                        ...
                        child: SfCartesianChart(
                          zoomPanBehavior: ZoomPanBehavior(
                              ...
                              selectionRectColor: const Color.fromARGB(255, 214,
                                  241, 234) // Enable double-tap zooming
                              ),
                          ...
                          child: gauges.SfRadialGauge(
                            axes: <gauges.RadialAxis>[
                              gauges.RadialAxis(
                                ...
                                showTicks: false,
                                startAngle:
                                    0, // Set the start angle to 0 degrees
                                endAngle: 360,
                                axisLineStyle: const gauges.AxisLineStyle(
                                  thickness: 0.1,
                                  cornerStyle: gauges.CornerStyle.bothCurve,
                            ...
                            axes: <gauges.RadialAxis>[
                              gauges.RadialAxis(
                                ...
                                pointers: <gauges.GaugePointer>[
                                  gauges.RangePointer(
                                    value: chartData.isNotEmpty
                                        ? double.parse(chartData.last.moisture
                                            .toStringAsFixed(2))
                                        : 0.0,
                                    width: 0.1,
                                    color:
